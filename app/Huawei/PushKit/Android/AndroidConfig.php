 ...
 */
namespace App\Huawei\PushKit\Android;

use App\Huawei\AndroidConfigDeliveryPriority;
use App\Huawei\Constants;
use App\Huawei\PushKit\ValidatorUtil;
...
class AndroidConfig
{
    ...
    private function check_parameter()
    {
        ...
        if (! empty($this->fast_app_target) && ! in_array($this->fast_app_target, array(1,2))) {
