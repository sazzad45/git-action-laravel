...
class CashInRequestValidation
{
    ...
    public function validate()
    {
        ...
        if ($error = (new LimitChecker(new LimitCheckerParam($this->receiver, $this->amount, $this->transactionTypeId, UserAccountType::FASTPAY_SAVINGS_ACCOUNT, config('basic_settings.currency_id'), true)))->check()->limitCrossed())
            return $error;
