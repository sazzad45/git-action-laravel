...
use App\Http\Requests\API\Auth\PinChange\UpdateRequest;
use Illuminate\Support\Facades\Cache;
use Illuminate\Support\Facades\Http;
use Illuminate\Support\Facades\Log;
use Illuminate\Validation\ValidationException;

class PinChangeStep2Controller extends APIBaseController
{
    public function update(UpdateRequest $request)
    {
        try {
            ...
            $this->logActivity('Pin changed with otp', $user);
    ...
    public function update_on_old_system($pin)
    {
        $response = Http::
            ...
            ->post(APIEndPoints::PIN_SET,['pin' => $pin, 'mobile_no' => auth()->user()->mobile_no, 'device_id' => 'RS', 'type' => 'B']);
