...
use App\Http\Requests\API\Auth\PinChange\Step1Request;
use App\Http\Traits\OTPTrait;
use App\Jobs\OTPForPINChange;
use Illuminate\Support\Facades\Log;

class PinChangeStep1Controller extends APIBaseController
{
    use OTPTrait;
    ...
    public function sendOTP(Step1Request $request)
    {
        try {
            ...
            $this->send_otp($user->email, $user->mobile_no, OTPPurpose::PIN_CHANGE, $request);
